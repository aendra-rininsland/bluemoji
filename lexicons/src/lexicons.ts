...
export const schemaDict = {
    ...
    defs: {
      bluemojiPackView: {
        ...
        properties: {
          ...
          items: {
            type: 'ref',
            ref: 'lex:blue.moji.pack.defs#listViewBasic',
          },
          listItemsSample: {
            type: 'array',
            maxLength: 12,
            items: {
              type: 'ref',
              ref: 'lex:blue.moji.pack.defs#listItemView',
            },
          },
          labels: {
            type: 'array',
      ...
      listItemView: {
        ...
        properties: {
          ...
          subject: {
            type: 'ref',
            ref: 'lex:blue.moji.collection.defs#itemView',
          },
        },
      },
    },
        ...
        output: {
          ...
          schema: {
            ...
            properties: {
              bluemojiPack: {
                type: 'ref',
                ref: 'lex:blue.moji.pack.defs#bluemojiPackView',
              },
            },
          },
        },
  ...
  BlueMojiPackListitem: {
    lexicon: 1,
    id: 'blue.moji.pack.listitem',
    defs: {
      main: {
        type: 'record',
        description:
          "Record representing a Bluemoji's inclusion in a specific pack. The AppView will ignore duplicate listitem records (I think?)",
        key: 'tid',
        record: {
          type: 'object',
          required: ['subject', 'list', 'createdAt'],
          properties: {
            subject: {
              type: 'ref',
              ref: 'lex:blue.moji.collection.defs#itemView',
              description: 'The emoji which is included in the pack',
            },
            list: {
              type: 'string',
              format: 'at-uri',
