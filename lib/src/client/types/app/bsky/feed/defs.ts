...
export interface ReplyRef {
  ...
  root: $Typed<PostView> | $Typed<NotFoundPost> | $Typed<BlockedPost> | { $type: string };
  parent: $Typed<PostView> | $Typed<NotFoundPost> | $Typed<BlockedPost> | { $type: string };
...
export interface ThreadViewPost {
  ...
  post: PostView;
  parent?: $Typed<ThreadViewPost> | $Typed<NotFoundPost> | $Typed<BlockedPost> | { $type: string };
  replies?: (
...
export interface SkeletonFeedPost {
  ...
  post: string;
  reason?: $Typed<SkeletonReasonRepost> | $Typed<SkeletonReasonPin> | { $type: string };
