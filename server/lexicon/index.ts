...
export class BlueNS {
  ...
  constructor(server: Server) {
    this._server = server
    this.moji = new BlueMojiNS(server)
  }
}
...
export class BlueMojiNS {
  ...
  constructor(server: Server) {
    this._server = server
    this.collection = new BlueMojiCollectionNS(server)
    this.packs = new BlueMojiPacksNS(server)
    this.richtext = new BlueMojiRichtextNS(server)
  }
}
...
export class BlueMojiCollectionNS {
  ...
  getItem<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiCollectionGetItem.Handler<ExtractAuth<AV>>,
      BlueMojiCollectionGetItem.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.collection.getItem' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }

  listCollection<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiCollectionListCollection.Handler<ExtractAuth<AV>>,
      BlueMojiCollectionListCollection.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.collection.listCollection' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }
  ...
  putItem<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiCollectionPutItem.Handler<ExtractAuth<AV>>,
      BlueMojiCollectionPutItem.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.collection.putItem' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }

  saveToCollection<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiCollectionSaveToCollection.Handler<ExtractAuth<AV>>,
      BlueMojiCollectionSaveToCollection.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.collection.saveToCollection' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }
}
...
export class BlueMojiPacksNS {
  ...
  getActorPacks<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiPacksGetActorPacks.Handler<ExtractAuth<AV>>,
      BlueMojiPacksGetActorPacks.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.packs.getActorPacks' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }

  getPack<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiPacksGetPack.Handler<ExtractAuth<AV>>,
      BlueMojiPacksGetPack.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.packs.getPack' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }

  getPacks<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      BlueMojiPacksGetPacks.Handler<ExtractAuth<AV>>,
      BlueMojiPacksGetPacks.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'blue.moji.packs.getPacks' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }
}
